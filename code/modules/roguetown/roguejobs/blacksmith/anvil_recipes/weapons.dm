...
/datum/anvil_recipe/weapons/aalloy/khopesh
	...
	created_item = /obj/item/rogueweapon/sword/sabre/aalloy
...
/datum/anvil_recipe/weapons/ancient/gsw
	name = "Greatsword, Ancient (+2 Gilbronze)"
	created_item = /obj/item/rogueweapon/greatsword/ancient
	additional_items = list(/obj/item/ingot/gilbronze, /obj/item/ingot/gilbronze)
...
/datum/anvil_recipe/weapons/ancient/bardiche
	name = "Bardiche, Ancient (+1 log, +1 Gilbronze)"
...
/datum/anvil_recipe/weapons/ancient/grandmace
	name = "Grand Mace, Purified (+1 Gilbronze, +1 Small Log)"
	additional_items = list(/obj/item/ingot/gilbronze, /obj/item/grown/log/tree/small)
...
/datum/anvil_recipe/weapons/alloy/shield
	name = "Shield, Ancient (+1 Gilbronze, +1 Cured Leather)"
	additional_items = list(/obj/item/ingot/gilbronze, /obj/item/natural/hide/cured)
